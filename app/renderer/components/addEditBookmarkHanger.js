  ...
  render () {
    return <div className={cx({
      ...
      <div className='bookmarkForm' onClick={this.onClick}>
        <div className={cx({
          arrowUp: !this.props.isModal,
          withStopButton: !this.props.isModal && this.props.withStopButton,
          withHomeButton: !this.props.isModal && this.props.withHomeButton,
          withoutButtons: !this.props.isModal && this.props.withoutButtons
        })} />
